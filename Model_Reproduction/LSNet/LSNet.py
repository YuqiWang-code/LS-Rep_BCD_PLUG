...
class LSNet(nn.Module):
    def __init__(self, pretrained_path=None):
        ...
        # rgb (T1), depth (T2) encode — both share same pretrained weights
        self.rgb_pretrained = mobilenet_v2(pretrained=True, pretrained_path=pretrained_path)
        self.depth_pretrained = mobilenet_v2(pretrained=True, pretrained_path=pretrained_path)
